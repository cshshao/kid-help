...
public class ErtongxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ErtongxinxiEntity ertongxinxi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ErtongxinxiEntity ertongxinxi, HttpServletRequest request){
        EntityWrapper<ErtongxinxiEntity> ew = new EntityWrapper<ErtongxinxiEntity>();
		PageUtils page = ertongxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, ertongxinxi), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R save(@RequestBody ErtongxinxiEntity ertongxinxi, HttpServletRequest request){
    	ertongxinxi.setId(System.currentTimeMillis()+new Double(Math.floor(Math.random()*1000)).longValue());
