          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="帮扶物品" prop="bangfuwupin">
          <el-input v-model="ruleForm.bangfuwupin" 
              placeholder="帮扶物品" clearable  :readonly="ro.bangfuwupin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="帮扶物品" prop="bangfuwupin">
              <el-input v-model="ruleForm.bangfuwupin" 
                placeholder="帮扶物品" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="帮扶金额" prop="bangfujine">
          <el-input v-model="ruleForm.bangfujine" 
              placeholder="帮扶金额" clearable  :readonly="ro.bangfujine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="帮扶金额" prop="bangfujine">
              <el-input v-model="ruleForm.bangfujine" 
                placeholder="帮扶金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" label="工作单位" prop="gongzuodanwei">
              <el-input v-model="ruleForm.gongzuodanwei" 
                placeholder="工作单位" readonly></el-input>
                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="帮扶内容" prop="bangfuneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.bangfuneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.bangfuneirong" label="帮扶内容" prop="bangfuneirong">
                    <span v-html="ruleForm.bangfuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='bangfuwupin'){
            this.ruleForm.bangfuwupin = obj[o];
	    this.ro.bangfuwupin = true;
            continue;
          }
	            	            if(o=='bangfujine'){
            this.ruleForm.bangfujine = obj[o];
	    this.ro.bangfujine = true;
            continue;
          }
	            	            if(o=='bangfuneirong'){
            this.ruleForm.bangfuneirong = obj[o];
	    this.ro.bangfuneirong = true;
            continue;
          }
	            	            if(o=='zhanghao'){
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.jiatingzhuzhi = json.jiatingzhuzhi
                                  		...
                                  		if(json.gongzuodanwei!=''&&json.gongzuodanwei){
              		this.ruleForm.gongzuodanwei = json.gongzuodanwei
		}
                                                                                                } else {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `bangfuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.bangfuxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
