<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="邮件编号" prop="youjianbianhao">
          <el-input v-model="ruleForm.youjianbianhao" 
              placeholder="邮件编号" clearable  :readonly="ro.youjianbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="邮件编号" prop="youjianbianhao">
              <el-input v-model="ruleForm.youjianbianhao" 
                placeholder="邮件编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="数量" prop="shuliang">
              <el-input v-model="ruleForm.shuliang" 
                placeholder="数量" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="寄件日期" prop="jijianriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jijianriqi" 
                type="date"
                placeholder="寄件日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jijianriqi" label="寄件日期" prop="jijianriqi">
              <el-input v-model="ruleForm.jijianriqi" 
                placeholder="寄件日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
            ...
            ruleForm: {
                	        youjianbianhao: '',
	                        	        ...
	                        	        xingming: '',
                                                                                                                            ...
                                                                                                                            rules: {
                  youjianbianhao: [
                            { required: true, message: '邮件编号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  wupinmingcheng: [
                                    	                                                              ],
                  wupinleixing: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='youjianbianhao'){
            this.ruleForm.youjianbianhao = obj[o];
	    this.ro.youjianbianhao = true;
            continue;
          }
	            	            if(o=='wupinmingcheng'){
	    ...
	    this.ro.shuliang = true;
            continue;
	            	            ...
	            	            if(o=='jijianriqi'){
            this.ruleForm.jijianriqi = obj[o];
	    this.ro.jijianriqi = true;
            continue;
          }
	            	            if(o=='zhanghao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `bangfuwuzi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.bangfuwuziCrossAddOrUpdateFlag = false;
                  this.parent.search();
