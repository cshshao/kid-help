          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shenfenzhengzheng" label="身份证正" prop="shenfenzhengzheng">
          <file-upload
          tip="点击上传身份证正"
          action="file/upload"
          :limit="3"
          ...
          @change="shenfenzhengzhengUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shenfenzhengzheng" label="身份证正" prop="shenfenzhengzheng">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shenfenzhengzheng.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shenfenzhengfan" label="身份证反" prop="shenfenzhengfan">
          <file-upload
          tip="点击上传身份证反"
          action="file/upload"
          :limit="3"
          ...
          @change="shenfenzhengfanUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shenfenzhengfan" label="身份证反" prop="shenfenzhengfan">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shenfenzhengfan.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
	...
	nianling : false,
	lianxidianhua : false,
	shenfenzhengzheng : false,
	shenfenzhengfan : false,
	gongzuodanwei : false,
	jiatingzhuzhi : false,
      },
            ruleForm: {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='shenfenzhengzheng'){
            this.ruleForm.shenfenzhengzheng = obj[o];
	    this.ro.shenfenzhengzheng = true;
            continue;
          }
	            	            if(o=='shenfenzhengfan'){
            this.ruleForm.shenfenzhengfan = obj[o];
	    this.ro.shenfenzhengfan = true;
            continue;
          }
	            	            if(o=='gongzuodanwei'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `bangfuren/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.bangfurenCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
				...
				this.addEditUploadStyleChange()
                                                        ...
                                                        shenfenzhengzhengUploadChange(fileUrls) {
                this.ruleForm.shenfenzhengzheng = fileUrls;
				this.addEditUploadStyleChange()
            },
                                shenfenzhengfanUploadChange(fileUrls) {
