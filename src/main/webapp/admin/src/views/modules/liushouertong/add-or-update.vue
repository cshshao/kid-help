  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="年级" prop="nianji">
              <el-input v-model="ruleForm.nianji" 
                placeholder="年级" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="父母" prop="fumu">
          <el-input v-model="ruleForm.fumu" 
              placeholder="父母" clearable  :readonly="ro.fumu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="父母" prop="fumu">
              <el-input v-model="ruleForm.fumu" 
                placeholder="父母" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="家庭住址" prop="jiatingzhuzhi">
              <el-input v-model="ruleForm.jiatingzhuzhi" 
                placeholder="家庭住址" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="现居人口" prop="xianjurenkou">
          <el-input v-model="ruleForm.xianjurenkou" 
              placeholder="现居人口" clearable  :readonly="ro.xianjurenkou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="现居人口" prop="xianjurenkou">
              <el-input v-model="ruleForm.xianjurenkou" 
                placeholder="现居人口" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否帮扶" prop="shifoubangfu">
          <el-select v-model="ruleForm.shifoubangfu" placeholder="请选择是否帮扶">
            <el-option
                v-for="(item,index) in shifoubangfuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否帮扶" prop="shifoubangfu">
	      <el-input v-model="ruleForm.shifoubangfu"
                placeholder="是否帮扶" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="家庭描述" prop="jiatingmiaoshu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="家庭描述"
                  v-model="ruleForm.jiatingmiaoshu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiatingmiaoshu" label="家庭描述" prop="jiatingmiaoshu">
                    <span>{{ruleForm.jiatingmiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiatingzhuzhi = true;
            continue;
	            	            ...
	            	            if(o=='xianjurenkou'){
            this.ruleForm.xianjurenkou = obj[o];
	    this.ro.xianjurenkou = true;
            continue;
          }
	            	            if(o=='jiatingmiaoshu'){
            this.ruleForm.jiatingmiaoshu = obj[o];
	    this.ro.jiatingmiaoshu = true;
            continue;
          }
	            	            if(o=='shifoubangfu'){
            this.ruleForm.shifoubangfu = obj[o];
	    this.ro.shifoubangfu = true;
            continue;
          }
	                    }
                                                                                                                                                                                                              }
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.xingbieOptions = "男,女".split(',')
                                                                                                                                                                                                          this.shifoubangfuOptions = "未帮扶,已帮扶".split(',')
                            },
                                                                                                        // 多级联动参数
                                                                                                                                    info(id) {
      this.$http({
